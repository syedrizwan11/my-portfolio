...
export const ResumeContainer = () => {
  return (
    <section className="relative group bg-background border-2 border-white p-5 pb-3 text-sm sm:min-w-[20rem] max-w-[20rem] box-content rounded-2xl card ">
      <div className="absolute z-1 w-[20%] h-[20%] flex items-center justify-center bg-teal-600 rounded-tr-[15px] rounded-bl-[100%] transition-all duration-500 top-0 right-0 group-hover:bg-cyan-400"></div>
      <div className="absolute z-1 w-[20%] h-[20%] flex items-center justify-center bg-teal-600 rounded-tr-[100%] rounded-bl-[15px] transition-all duration-500 bottom-0 left-0 group-hover:bg-cyan-400"></div>
      ...
      <a
        ...
        className="relative z-10 group p-2 rounded-xl w-fit ml-auto px-4 flex items-center justify-center mt-10 gap-4 bg-gradient-to-r from-teal-400 from-30% to-sky-400 group-hover:from-sky-400 group-hover:to-teal-400 shadow shadow-indigo-200 border-solid border-sky-300 text-black text-shadow-xs text-shadow-cyan-200 text-[1rem] sm:text-xl cursor-pointer hover:scale-105 transition"
      >
        Download Resume{" "}
